...
class PeoplePagedListAdapter(private val actions: PeopleListActions) :
    PagingDataAdapter<People, PeoplePagedListAdapter.PeopleListAdapterViewHolder>(PeopleItemDiffCallBack()) {
